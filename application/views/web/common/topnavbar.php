    ...
    <div class="container"> 
      ...
      <nav> 
        ...
        <div class="menu-toggle">
        	<img class="nav_logo_img img-fluid" src="<?php echo base_url().'assets/web/';?><?php echo base_url().'assets/web/';?>images/header-logo.svg" alt="header-logo.svg">
        ...
        <ul id="respMenu" class="ace-responsive-menu text-right" data-menu-style="horizontal">
          ...
          <li class="list-inline-item add_listing"><a href="page-dashboard-new-property.html"><span class="icon flaticon-button"></span><span class="dn-lg"> Post property<span class="theader__supText">FREE</span></span></a></li>
        </ul>
      </nav>
    </div>
  </header>