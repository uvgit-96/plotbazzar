...
<div class="wrapper">
    ...
    <div class="container"> 
      ...
      <nav> 
        ...
        <a href="index.html" class="navbar_brand float-left dn-md">
					...
					<img class="logo2 img-fluid" src="<?php echo base_url().'assets/web/';?>images/header-logo.svg" alt="header-logo.svg">
					<span>Houzing</span>
				</a> 
        ...
        <ul id="respMenu2" class="ace-responsive-menu float-right wa" data-menu-style="horizontal">
          ...
          <li class="list-inline-item add_listing home9"><a href="page-dashboard-new-property.html"><span class="icon flaticon-button mr7 mr0-lg"></span><span class="dn-lg"> Create Listing</span></a></li>
        </ul>
      </nav>
    </div>
  </header>
        ...
        <div class="col-lg-12">
          <div class="main-banner-wrapper home10">
            <div class="banner-style-one owl-theme owl-carousel">
              <div class="slide slide-one" style="background-image: url(<?php echo base_url().'assets/web/';?>images/home/8.jpg);height: 690px;">
                <div class="container">
                  <div class="row home-content">
                    <div class="col-lg-12 text-center p0">
                      ...
                      <ul class="mb0 property_details">
                        <li class="list-inline-item"><span class="icon flaticon-bed"></span><br> <span class="text">4 Beds</span></li>
                        <li class="list-inline-item"><span class="icon flaticon-bath"></span><br> <span class="text">5 Baths</span></li>
                        <li class="list-inline-item"><span class="icon flaticon-car"></span><br> <span class="text">1 Garage</span></li>
                        <li class="list-inline-item"><span class="icon flaticon-ruler"></span><br> <span class="text">1200 Sq Ft</span></li>
                      </ul>
              ...
              <div class="slide slide-one" style="background-image: url(<?php echo base_url().'assets/web/';?>images/home/7.jpg);height: 690px;">
                <div class="container">
                  <div class="row home-content">
                    <div class="col-lg-12 text-center p0">
              ...
              <div class="slide slide-one" style="background-image: url(<?php echo base_url().'assets/web/';?>images/home/5.jpg);height: 690px;">
                <div class="container">
                  <div class="row home-content">
                    <div class="col-lg-12 text-center p0">
                      <h3 class="banner-title">Gorgeous Villa Bay View</h3>
      ...
      <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-3 col-xl-2">
          <div class="explore_city custom_class_from_520 fl-520">
            <div class="thumb"><img class="img-fluid" src="<?php echo base_url().'assets/web/';?>images/cities/1.jpg" alt="1.jpg"></div>
            <div class="details">
          ...
          <div class="explore_city custom_class_from_520 fr-520">
            <div class="thumb"><img class="img-fluid" src="<?php echo base_url().'assets/web/';?>images/cities/2.jpg" alt="2.jpg"></div>
            <div class="details">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 col-xl-2">
          <div class="explore_city custom_class_from_520 fl-520">
            <div class="thumb"><img class="img-fluid" src="<?php echo base_url().'assets/web/';?>images/cities/3.jpg" alt="3.jpg"></div>
            <div class="details">
          ...
          <div class="explore_city custom_class_from_520 fr-520">
            <div class="thumb"><img class="img-fluid" src="<?php echo base_url().'assets/web/';?>images/cities/4.jpg" alt="4.jpg"></div>
            <div class="details">
        ...
        <div class="col-md-6 col-lg-3 col-xl-6">
          <div class="explore_city style2">
            <div class="thumb"><img class="img-fluid" src="<?php echo base_url().'assets/web/';?>images/cities/5.jpg" alt="5.jpg"></div>
            <div class="details">
        ...
        <div class="col-md-6 col-lg-3 col-xl-2">
          <div class="explore_city custom_class_from_767 fl-767">
            <div class="thumb"><img class="img-fluid" src="<?php echo base_url().'assets/web/';?>images/cities/6.jpg" alt="6.jpg"></div>
            <div class="details">
          ...
          <div class="explore_city custom_class_from_767 fr-767">
            <div class="thumb"><img class="img-fluid" src="<?php echo base_url().'assets/web/';?>images/cities/7.jpg" alt="7.jpg"></div>
            <div class="details">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-xl-6">
          <div class="app_img text-center tal-md mb30-sm">
            <img src="<?php echo base_url().'assets/web/';?>images/resource/mobile.png" alt="mobile.png">
          </div>
        </div>
        <div class="col-md-6 col-xl-4">
          <div class="app_details mt80 mt0-md">
            <h4 class="text-thm mb25">GET THE APP</h4>
            <h2 class="mb30">Everything You Need to Find a Home on Mobile</h2>
            <p>Search through millions of jobs and find the right fit. Simply <br> swipe right to apply.</p>
            <div class="app_btn mt40">
              <a href="#" class="btn btn-dark btn_apple">
                <span class="thumb float-left"><img src="<?php echo base_url().'assets/web/';?>images/resource/apple.png" alt="apple.png"></span> 
                <span class="details">
                  <span class="subtitle">Download on the</span>
                  <span class="title">Apple Store</span>
                </span>
              </a>
              <a href="#" class="btn btn-dark btn_gplay ml20 ml0-md">
                <span class="thumb float-left"><img src="<?php echo base_url().'assets/web/';?>images/resource/play-store.png" alt="apple.png"></span>
                <span class="details">
                  <span class="subtitle">Download on the</span>
          ...
          <div class="for_blog feat_property">
            ...
            <div class="details">
              <div class="tc_content">
                ...
                <a class="text-thm tdu read_more_btn" href="page-blog-single.html">READ MORE</a> </div>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-xl-3">
  ...
  <!-- Start Partners -->
  <section class="start-partners home1 bgc-thm">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-4">
          <div class="start_partner text-center mb30">
