...
<div class="wrapper">
  ...
  <!-- Main Header Nav -->
  <header class="header-nav menu_style_home_one home7_style navbar-scrolltofixed stricky main-menu">
    <div class="container-fluid"> 
      ...
      <nav> 
        ...
        <ul id="respMenu2" class="ace-responsive-menu widget_menu_home2 wa" data-menu-style="horizontal">
          ...
          <li class="list-inline-item list_s"><a href="#" class="btn" data-toggle="modal" data-target="#logInModal"><span class="flaticon-user"></span> <span>Login/Register</span></a></li>
      ...
      <div class="row posr">
        <div class="col-md-6 col-lg-6">
          <div class="home_content home7">
            <p class="fz16 text-white text-uppercase">It's great to be home!</p>
            <h2 class="title text-white fz60 fw700">Find a home that suits your lifestyle</h2>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-12 col-xl-6">
          <div class="feat_property list listing">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/lls71.jpg" alt="lls71.jpg">
              ...
              <div class="fp_footer">
                <ul class="fp_meta float-left mb0">
                  <li class="list-inline-item">
                    <a href="#"><small><del class="body-color">$2,800/mo</del></small><br>
                    <span class="heading-color fw600">$2,300/mo</span></a>
                  </li>
                </ul>
        ...
        <div class="col-md-6 col-lg-12 col-xl-6">
          <div class="feat_property list listing">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/lls72.jpg" alt="lls72.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">FEATURED</a></li>
                </ul>
        ...
        <div class="col-md-6 col-lg-12 col-xl-6">
          <div class="feat_property list listing">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/lls73.jpg" alt="lls73.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">FEATURED</a></li>
                </ul>
        ...
        <div class="col-md-6 col-lg-12 col-xl-6">
          <div class="feat_property list listing">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/lls74.jpg" alt="lls74.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">FEATURED</a></li>
                </ul>
        ...
        <div class="col-md-6 col-lg-12 col-xl-6">
          <div class="feat_property list listing">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/lls75.jpg" alt="lls75.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">FEATURED</a></li>
                </ul>
        ...
        <div class="col-md-6 col-lg-12 col-xl-6">
          <div class="feat_property list listing">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/lls76.jpg" alt="lls76.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">FEATURED</a></li>
                </ul>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="load_more_btn text-center mt20">
            <a class="btn btn-lg btn-thm" href="page-listing-v3.html">vıew MORE</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- How It Works -->
  <section class="whychose_us bgc-alice-blue pb70">
    <div class="container">
      <div class="row">
  ...
  <!-- Feature Properties -->
  <section class="best_property_value bg-img6 parallax" data-stellar-background-ratio="0.2">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="main-title text-center">
            <h2 class="text-white">Best Property Value</h2>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="popular_listing_slider1 home7">
            <div class="item">
  ...
  <!-- Our Testimonials -->
  <section class="our-testimonial pb40">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="main-title text-center">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4">
          <div class="testimonial_post_home3 home7">
            <div class="details">
              <p>“ I believe in lifelong learning and Skola is a great place to learn from experts. I've learned a lot and recommend it to all my friends.  Enim condimentum aliquam consectetur a sed pharetra feugiat blandit tincidunt. “</p>
            </div>
            <div class="thumb">
              <img src="<?php echo base_url().'assets/web/';?>images/testimonial/1.png" alt="1.png">
              <h4 class="title">Marvin McKinney <br><small>Designer</small></h4>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4">
          <div class="testimonial_post_home3 home7">
            ...
            <div class="thumb">
              <img src="<?php echo base_url().'assets/web/';?>images/testimonial/2.png" alt="2.png">
              <h4 class="title">Theresa Webb <br><small>Host</small></h4>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-4">
          <div class="testimonial_post_home3 home7">
            ...
            <div class="thumb">
              <img src="<?php echo base_url().'assets/web/';?>images/testimonial/3.png" alt="3.png">
              <h4 class="title">Robert Fox <br><small>Reporter</small></h4>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- Our Footer -->
  <section class="footer_one home7 bg-ptrn4">
    <div class="container pb90">
      <div class="row">
        <div class="col-sm-5 col-md-5 col-lg-3 col-xl-2">
          <div class="footer_contact_widget home10">
            <h4>Contact Us</h4>
          ...
          <div class="footer_social_widget home10 mt20">
            <ul class="mb0">
        ...
        <div class="col-sm-3 col-md-2 col-lg-2 col-xl-2">
          <div class="footer_qlink_widget home10">
            <h4>Discover</h4>
            <ul class="list-unstyled">
        ...
        <div class="col-sm-4 col-md-3 col-lg-2 col-xl-2">
          <div class="footer_qlink_widget home10 pl0">
        ...
        <div class="col-sm-7 col-md-6 col-lg-3 col-xl-4">
          <div class="footer_social_widget home10">
            <h4>Subscribe</h4>
            <p class="mb30 text-white">We don’t send spam so don’t worry.</p>
            <form class="footer_mailchimp_form home1">
    ...
    <div class="container pt10 pb30">
      <div class="row">
        <div class="col-md-4 col-lg-4">
          <div class="copyright-widget home10 mt10 mb15-767">
        ...
        <div class="col-md-4 col-lg-4">
          <div class="footer_menu_widget home10 text-right tac-md mt15">
            <ul>
  ...
  <a class="scrollToHome home1" href="#"><i class="fa fa-angle-up"></i></a> </div>
<!-- Wrapper End --> 
