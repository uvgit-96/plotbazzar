...
<div class="wrapper">
  ...
  <!-- Main Header Nav -->
  <header class="header-nav menu_style_home_one home4_style navbar-scrolltofixed stricky main-menu">
    <div class="container"> 
      <!-- Ace Responsive Menu -->
      <nav> 
        <!-- Menu Toggle btn-->
  ...
  <!-- Home Design -->
  <section class="home-one home1-overlay bg-home4">
    <div class="container">
      <div class="row posr">
        <div class="col-lg-12">
          <div class="home_content home1 custom_width home4">
            <div class="home-text text-center">
              <p class="fz16 color-white">It's great to be home!</p>
              ...
              <div class="tab-content" id="myTabContent2">
                <div class="tab-pane fade" id="buy" role="tabpanel" aria-labelledby="buy-tab">
                  <div class="home_adv_srch_opt home4">
                    <div class="wrapper">
                      <div class="home_adv_srch_form home4">
                        <form class="bgc-white">
                          <div class="form-row align-items-center">
                            ...
                            <div class="col-auto home_form_input2">
                              <button type="submit" class="btn search-btn ml15 ml0-991"><span class="fa fa-search"></span> Search</button>
                            </div>
                          </div>
                        </form>
                      </div>
  ...
  <section class="hot_localtion pb0">
    <div class="container">
      <div class="row">
          ...
          <div class="recent_property_slider_home1">
            <div class="item">
              <div class="feat_property recent">
                <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/rp1.jpg" alt="rp1.jpg">
            ...
            <div class="item">
              <div class="feat_property recent">
                <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/rp2.jpg" alt="rp2.jpg">
                  <div class="thmb_cntnt">
                    <ul class="tag mb0">
                      <li class="list-inline-item"><a href="#">FEATURED</a></li>
                    </ul>
            ...
            <div class="item">
              <div class="feat_property recent">
                <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/rp3.jpg" alt="rp3.jpg">
                  <div class="thmb_cntnt">
                    <ul class="tag mb0">
                      <li class="list-inline-item"><a href="#">FEATURED</a></li>
                    </ul>
            ...
            <div class="item">
              <div class="feat_property recent">
                <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/rp4.jpg" alt="rp3.jpg">
                  <div class="thmb_cntnt">
                    <ul class="tag mb0">
                      <li class="list-inline-item"><a href="#">FEATURED</a></li>
                    </ul>
  ...
  <section class="property-city bg-ptrn2 bgc-dark pb70">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="main-title text-center">
            <h2 class="text-white">Explore Our Properties</h2>
          ...
          <div class="feature_place_home2_slider">
            <div class="item">
              <div class="properti_city">
                <div class="thumb"><img class="img-fluid w100" src="<?php echo base_url().'assets/web/';?>images/property/ep1.jpg" alt="ep1.jpg"></div>
                <div class="overlay">
                  <div class="details">
            ...
            <div class="item">
              <div class="properti_city">
                <div class="thumb"><img class="img-fluid w100" src="<?php echo base_url().'assets/web/';?>images/property/ep2.jpg" alt="ep2.jpg"></div>
                <div class="overlay">
                  <div class="details">
            ...
            <div class="item">
              <div class="properti_city">
                <div class="thumb"><img class="img-fluid w100" src="<?php echo base_url().'assets/web/';?>images/property/ep3.jpg" alt="ep3.jpg"></div>
                <div class="overlay">
                  <div class="details">
            ...
            <div class="item">
              <div class="properti_city">
                <div class="thumb"><img class="img-fluid w100" src="<?php echo base_url().'assets/web/';?>images/property/ep4.jpg" alt="ep4.jpg"></div>
                <div class="overlay">
                  <div class="details">
            ...
            <div class="item">
              <div class="properti_city">
                <div class="thumb"><img class="img-fluid w100" src="<?php echo base_url().'assets/web/';?>images/property/ep5.jpg" alt="ep.jpg"></div>
                <div class="overlay">
                  <div class="details">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-xl-3">
          <div class="for_blog feat_property home4">
  ...
  <!-- Our Divider -->
  <section class="divider home4 bg-img4 parallax" data-stellar-background-ratio="0.2">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="property_sell_home4">
            <h2 class="title text-white mb20">We Help You Buy or Sell <br> Your Property Quickly</h2>
            <p class="fz16 text-white fw500">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</p>
          </div>
        </div>
        <div class="col-lg-6 col-xl-4 offset-xl-1">
          <div class="divider_contact_form">
            <div class="wrapper">
              <form>
                <div class="row">
                  <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input class="form-control form_control" type="text" placeholder="(1) 123 567 976">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>EMAIL</label>
                      <input class="form-control form_control" type="email" placeholder="creativelayers088@gmail.com">
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group">
                    ...
                    <div class="form-group mb0">
                      <button type="button" class="btn btn-block form_btn">Send Message</button>
                    </div>
                  </div>
                </div>
              </form>
  ...
  <!-- Our Footer -->
  <section class="footer_one home1 home4">
      ...
      <div class="row">
        ...
        <div class="col-sm-7 col-md-6 col-lg-3 col-xl-4">
          <div class="footer_social_widget home4">
            ...
            <form class="footer_mailchimp_form home4">
              <div class="form-row align-items-center">
                <div class="col-auto">
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-lg-4">
          <div class="footer_logo_widget home4 text-center mb15-767">
            <div class="wrapper">
              <div class="logo text-center"> <img src="<?php echo base_url().'assets/web/';?>images/footer-logo2.svg" alt="footer-logo2.svg"> <span class="logo_title pl15">Houzing</span> </div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-lg-4">
