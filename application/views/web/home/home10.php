...
<div class="wrapper">
  ...
  <!-- Main Header Nav -->
  <header class="header-nav menu_style_home_one home10_style navbar-scrolltofixed stricky main-menu">
    <div class="container"> 
      <!-- Ace Responsive Menu -->
      <nav> 
        <!-- Menu Toggle btn-->
        ...
        <a href="index.html" class="navbar_brand float-left dn-md">
					<img class="logo1 img-fluid" src="<?php echo base_url().'assets/web/';?>images/header-logo4.svg" alt="header-logo.svg">
        ...
        <ul id="respMenu2" class="ace-responsive-menu float-right wa" data-menu-style="horizontal">
          ...
          <li class="list-inline-item add_listing home10"><a href="page-dashboard-new-property.html"><span class="icon flaticon-button"></span><span class="dn-lg"> Create Listing</span></a></li>
        </ul>
      </nav>
    </div>
  </header>
  ...
  <!-- Home Design -->
  <section class="home-one bg-home10 mt0">
    <div class="container">
      <div class="row ">
        <div class="col-lg-6 col-xl-5">
          <div class="home_content home10">
            <div class="home-text home10">
              <p class="fz16">It's great to be home!</p>
              <h2 class="fz60">Making <span class="text-thm5">Good</span> things happen.</h2>
              <a class="btn btn-thm2" href="#">READ MORE</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="about-section pb70">
    <div class="container">
      <div class="row">
        <div class="col-lg-5">
          <div class="about_thumb mb30">
            <img class="img-fluid w100" src="<?php echo base_url().'assets/web/';?>images/about/1.jpg" alt="1.jpg">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="about_content home10 mb30">
            <h2 class="mb50">Hi, my name's Alex. I'm a New York Real Estate agent.</h2>
            <p>Arcu mattis ante sed est eget nibh velit praesent. Turpis at pharetra est quam volutpat sed eget convallis. In morbi turpis tortor nisl vel purus. Nisl massa scelerisque quisque quam nulla nec risus duis vitae. </p>
            <p>Morbi ut egestas commodo enim in leo hendrerit euismod. Praesent pellentesque congue sit nunc eget. Convallis facilisi ut condimentum ac lorem phasellus amet. </p>
  ...
  <!-- Our Testimonials -->
  <section class="our-testimonials pb40 pb100-lg">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="main-title text-center">
  ...
  <!-- Our Divider -->
  <section class="divider home4 bg-img10 parallax" data-stellar-background-ratio="0.2">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="property_sell_home10">
            <h2 class="title text-white mb20">Arrange a meeting with Alex Davis to <br> buy, sell or rent your home.</h2>
        ...
        <div class="col-lg-6 col-xl-4 offset-xl-1">
          <div class="divider_contact_form home10">
            <div class="wrapper">
              <form>
                <div class="row">
                  <div class="col-md-12">
  ...
  <section class="our-team pb40">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="main-title text-center">
            <h2>Our agents at your service</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
          </div>
        </div>
      </div>
  ...
  <!-- Our Footer -->
  <section class="footer_one home1 home10">
      ...
      <div class="row">
        ...
        <div class="col-sm-7 col-md-6 col-lg-3 col-xl-4">
          <div class="footer_social_widget home10">
            ...
            <form class="footer_mailchimp_form home10">
  ...
  <a class="scrollToHome home10" href="#"><i class="fa fa-angle-up"></i></a> </div>
<!-- Wrapper End --> 
