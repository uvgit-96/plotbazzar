	...
	<div class="extra-dashboard-menu dn-lg">
		<div class="ed_menu_list">
			<ul>
				...
				<li><a href="page-dashboard-profile.html"><span class="flaticon-user"></span> My Profile</a></li>
				<li><a href="page-dashboard-property.html"><span class="flaticon-house"></span> My Properties List</a></li>
				<li><a class="active" href="page-add-new-property.html"><span class="flaticon-button"></span> Add New Property</a></li>
				<li><a href="page-dashboard-favorites.html"><span class="flaticon-heart-shape-outline"></span> Favorites</a></li>
				<li><a href="page-dashboard-save-search.html"><span class="flaticon-magnifiying-glass"></span> Saved Searches</a></li>
				<li><a href="page-dashboard-invoices.html"><span class="flaticon-invoice"></span> My Invoices</a></li>
				<li><a href="page-dashboard-message.html"><span class="flaticon-mail-inbox-app"></span> Inbox</a></li>
				<li><a href="page-dashboard-logout.html"><span class="flaticon-logout"></span> Logout</a></li>
			</ul>
		</div>
	</div>
		            ...
		            <form class="contact_form" name="contact_form" action="#" method="post" novalidate>
		              <div class="row">
										...
										<div class="col-lg-12 mt50 mb15">
											<h5 class="mb20">Gallery <?php echo base_url().'assets/web/';?>images (optional)</h5>
											<ul class="mb0">
												<li class="list-inline-item vat">
											  	<div class="upload_file_input_add_remove">
											    	...
											    	<img id="ImgPreview2" src="<?php echo base_url().'assets/web/';?>images/resource/upload-img.png" class="preview2" alt=""/>
