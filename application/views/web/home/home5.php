...
<div class="wrapper">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-5 col-xl-5">
          <ul class="home5_header_top_contact tac-sm">
            <li class="list-inline-item"><a class="text-white" href="#"><span class="flaticon-phone"></span> (+88) 1990 6886</a></li>
            <li class="list-inline-item"><a class="text-white" href="#"><span class="flaticon-mail-inbox-app"></span> info@houzing.com</a></li>
          </ul>
        </div>
        <div class="col-md-6 col-lg-7 col-xl-7">
          <ul class="sign_up_btn home5 tac-sm text-right">
            <li class="list-inline-item"><a class="text-white" href="#"><span class="fa fa-facebook"></span></a></li>
            <li class="list-inline-item"><a class="text-white" href="#"><span class="fa fa-twitter"></span></a></li>
            <li class="list-inline-item"><a class="text-white" href="#"><span class="fa fa-instagram"></span></a></li>
            <li class="list-inline-item"><a class="text-white" href="#"><span class="fa fa-linkedin"></span></a></li>
            <li class="list-inline-item"><a href="#" class="btn" data-toggle="modal" data-target="#logInModal"><i class="flaticon-user"></i> <span class="dn-md text">Login/Register</span></a></li>
  ...
  <br>
  <!-- Main Header Nav -->
  <header class="header-nav menu_style_home_one home5_style navbar-scrolltofixed stricky main-menu">
    <div class="container"> 
      <!-- Ace Responsive Menu -->
      <nav> 
        <!-- Menu Toggle btn-->
  ...
  <div id="page" class="stylehome1 home5">
  ...
  <!-- Home Design -->
  <section class="home-one home5_style">
    <div class="container-fluid p0">
      <div class="row">
        <div class="col-lg-12">
          <div class="main-banner-wrapper">
            <div class="banner-style-one owl-theme owl-carousel">
              <div class="slide slide-one" style="background-image: url(<?php echo base_url().'assets/web/';?>images/home/5.jpg);height: 860px;"></div>
              <div class="slide slide-one" style="background-image: url(<?php echo base_url().'assets/web/';?>images/home/4.jpg);height: 860px;"></div>
              <div class="slide slide-one" style="background-image: url(<?php echo base_url().'assets/web/';?>images/home/3.jpg);height: 860px;"></div>
            </div>
      ...
      <div class="row posr justify-content-center">
        <div class="col-xl-8">
          <div class="home_content home5">
            <div class="home-text text-center mb25">
              <p class="fz16 color-white ttu">It's great to be home!</p>
              <h2 class="fz60">Find Your Future Home</h2>
            </div>
            <div class="row justify-content-center">
              <div class="col-lg-10 col-xl-12 mb55">
                <div class="home_adv_srch_opt home4">
                  <div class="wrapper">
                    <div class="home_adv_srch_form home5">
                      <form class="bgc-white">
                        <div class="form-row">
                          ...
                          <div class="col-auto home_form_input2">
                            <button type="submit" class="btn search-btn"><span class="fa fa-search"></span> Search</button>
                          </div>
                        </div>
                      </form>
                    </div>
            ...
            <div class="row">
              <div class="col-lg-12 text-center">
                <em><p class="color-white mb25 fz15">What are you looking for?</p></em>
                <ul class="home5_iconbox mb0">
                  ...
                  <li class="list-inline-item">
                    <div class="icon">
                      <span class="flaticon-business-and-trade"></span>
                    </div>
                    <div class="details">
                      <p>Office</p>
                    </div>
                  ...
                  <li class="list-inline-item">
                    <div class="icon">
                      <span class="flaticon-villa"></span>
                    </div>
                    <div class="details">
                      <p>Villa</p>
                    </div>
                  </li>
                  <li class="list-inline-item dn-520">
                    <div class="icon">
                      <span class="flaticon-living-room"></span>
                    </div>
                    <div class="details">
                      <p>Room</p>
                    </div>
  ...
  <section class="recent-property pb0">
    <div class="container">
      <div class="row">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-xl-3">
          <div class="feat_property all_listing_style4">
            <div class="thumb">
              ...
              <div class="thmb_cntnt2 top right">
              ...
              <div class="fp_footer all_listing_style4">
                <ul class="fp_meta float-left mb0">
                  <li class="list-inline-item">
                    <a href="#">
                      <small><del>$2,800/mo</del></small><br>
                      <span class="fw600">$7,500/mo</span>
                    </a>
                  </li>
                </ul>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="feat_property all_listing_style4">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/fl2.jpg" alt="fl2.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">FEATURED</a></li>
                  <li class="list-inline-item"><a href="#">FOR SALE</a></li>
              ...
              <div class="fp_footer all_listing_style4">
                <ul class="fp_meta float-left mb0">
                  <li class="list-inline-item">
                    <a href="#">
                      <small><del>$2,800/mo</del></small><br>
                      <span class="fw600">$5,250/mo</span>
                    </a>
                  </li>
                </ul>
                <ul class="fp_meta float-right mb0">
        ...
        <div class="col-md-6 col-xl-3">
          <div class="feat_property all_listing_style4">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/fl3.jpg" alt="fl3.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">FEATURED</a></li>
                  <li class="list-inline-item"><a href="#">FOR SALE</a></li>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="feat_property all_listing_style4">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/fl4.jpg" alt="fl4.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
        ...
        <div class="col-md-6 col-xl-3">
          <div class="feat_property all_listing_style4">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/bdh55.jpg" alt="bdh55.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">FEATURED</a></li>
                  <li class="list-inline-item"><a href="#">FOR SALE</a></li>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="feat_property all_listing_style4">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/bdh56.jpg" alt="bdh56.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">FEATURED</a></li>
                  <li class="list-inline-item"><a href="#">FOR SALE</a></li>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="feat_property all_listing_style4">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/bdh57.jpg" alt="bdh57.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">FEATURED</a></li>
                  <li class="list-inline-item"><a href="#">FOR SALE</a></li>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="feat_property all_listing_style4">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/bdh58.jpg" alt="bdh58.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">SOLD</a></li>
                  <li class="list-inline-item"><a href="#">SOLD</a></li>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="load_more_btn text-center mt20">
            <a class="btn btn-lg btn-thm" href="#">LOAD MORE</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Our Testimonials -->
  <section class="our-testimonials bgc-alice-blue pb40 pb100-lg">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="main-title text-center">
      ...
      <div class="row">
        <div class="col-md-6 col-xl">
          <div class="properti_city home3">
            <div class="thumb">
              <img class="img-fluid w100" src="<?php echo base_url().'assets/web/';?>images/property/ech51.jpg" alt="ech51.jpg">
            </div>
            <div class="overlay">
              <div class="details">
                <h4><a href="page-listing-single-v3.html">New York</a></h4>
        ...
        <div class="col-md-6 col-xl">
          <div class="properti_city home3">
            <div class="thumb">
              <img class="img-fluid w100" src="<?php echo base_url().'assets/web/';?>images/property/ech52.jpg" alt="ech52.jpg">
            </div>
            <div class="overlay">
              <div class="details">
                <h4><a href="page-listing-single-v3.html">London</a></h4>
        ...
        <div class="col-md-6 col-xl">
          <div class="properti_city home3">
            <div class="thumb">
              <img class="img-fluid w100" src="<?php echo base_url().'assets/web/';?>images/property/ech53.jpg" alt="ech53.jpg">
            </div>
            <div class="overlay">
              <div class="details">
                <h4><a href="page-listing-single-v3.html">Paris</a></h4>
        ...
        <div class="col-md-6 col-xl">
          <div class="properti_city home3">
            <div class="thumb">
              <img class="img-fluid w100" src="<?php echo base_url().'assets/web/';?>images/property/ech54.jpg" alt="ech54.jpg">
            </div>
            <div class="overlay">
              <div class="details">
        ...
        <div class="col-md-6 col-xl">
          <div class="properti_city home3">
            <div class="thumb">
              <img class="img-fluid w100" src="<?php echo base_url().'assets/web/';?>images/property/ech55.jpg" alt="ech55.jpg">
            </div>
            <div class="overlay">
              <div class="details">
                <h4><a href="page-listing-single-v3.html">Istanbul</a></h4>
  ...
  <!-- Our Divider -->
  <section class="divider home5 bg-img5 parallax" data-stellar-background-ratio="0.2">
    <div class="container">
      <div class="row">
        <div class="col-sm-6 col-xl-3">
          <div class="modern_appartment_widget home5">
            <h2 class="title text-white mb20">Hot This Week</h2>
            <p class="fz16 text-white mb20">Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
            <a class="btn" href="page-listing-all.html">vıew all</a>
          </div>
        </div>
        <div class="col-sm-6 col-xl-3">
          <div class="feat_property all_listing_style4 home5">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/fl1.jpg" alt="fl1.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
          ...
          <div class="team_slider_home1">
            <div class="item">
              <div class="team_member">
                <div class="thumb"> <img class="img-fluid" src="<?php echo base_url().'assets/web/';?>images/team/1.jpg" alt="1.jpg">
                  <div class="overylay">
            ...
            <div class="item">
              <div class="team_member">
                <div class="thumb"> <img class="img-fluid" src="<?php echo base_url().'assets/web/';?>images/team/2.jpg" alt="2.jpg">
                  <div class="overylay">
                    <ul class="social_icon">
                      <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
                      <li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>
            ...
            <div class="item">
              <div class="team_member">
                <div class="thumb"> <img class="img-fluid" src="<?php echo base_url().'assets/web/';?>images/team/3.jpg" alt="3.jpg">
                  <div class="overylay">
                    <ul class="social_icon">
                      <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
                      <li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>
            ...
            <div class="item">
              <div class="team_member">
                <div class="thumb"> <img class="img-fluid" src="<?php echo base_url().'assets/web/';?>images/team/4.jpg" alt="4.jpg">
                  <div class="overylay">
                    <ul class="social_icon">
                      <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
                      <li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>
            ...
            <div class="item">
              <div class="team_member">
                <div class="thumb"> <img class="img-fluid" src="<?php echo base_url().'assets/web/';?>images/team/5.jpg" alt="5.jpg">
                  <div class="overylay">
                    <ul class="social_icon">
                      <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
                      <li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>
        ...
        <div class="col-sm-6 col-xl-3">
          <div class="pricing_packages">
            <div class="heading text-center">
              ...
              <h2 class="text2">$99.89</h2>
              <h2 class="text1">$199.89</h2>
            </div>
            <div class="details">
              <ul  class="list">
        ...
        <div class="col-sm-6 col-xl-3">
          <div class="pricing_packages">
            <div class="heading text-center">
              ...
              <h2 class="text2">$199.89</h2>
              <h2 class="text1">$399.89</h2>
            </div>
            <div class="details">
              <ul class="list">
                <li>Basic Listing Submission</li>
        ...
        <div class="col-sm-6 col-xl-3">
          <div class="pricing_packages">
            <div class="heading text-center">
              ...
              <h2 class="text2">$299.89</h2>
              <h2 class="text1">$499.89</h2>
            </div>
            <div class="details">
              <ul class="list">
                <li>Basic Listing Submission</li>
        ...
        <div class="col-sm-6 col-xl-3">
          <div class="pricing_packages">
            <div class="heading text-center">
              ...
              <h2 class="text2">$499.89</h2>
              <h2 class="text1">$799.89</h2>
            </div>
            <div class="details">
              <ul class="list">
                <li>Basic Listing Submission</li>
  ...
  <!-- Our Partners -->
  <section class="our-partners pt90">
    <div class="container">
      <div class="row">
  ...
  <a class="scrollToHome home4" href="#"><i class="fa fa-angle-up"></i></a> </div>
<!-- Wrapper End --> 
