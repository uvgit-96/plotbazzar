...
<meta name="description" content="Plotbazzar - Real Estate HTML Template">
...
<!-- Title -->
<title>Plotbazzar - Real Estate HTML Template</title>
<!-- Favicon -->
	...
	<div id="page" class="stylehome1 h0">
		<div class="mobile-menu">
			<div class="header stylehome1">
				<div class="main_logo_home2 text-center"> <img class="nav_logo_img img-fluid mt10" src="images/header-logo.svg" alt="header-logo.svg"> <span class="mt15">Plotbazzar</span> </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-lg-4">
          <div class="footer_logo_widget text-center mb15-767">
            <div class="wrapper">
              <div class="logo text-center"> <img src="<?php echo base_url().'assets/web/';?>images/footer-logo.svg" alt="footer-logo.svg"> <span class="logo_title text-white pl15">Plotbazzar</span> </div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-lg-4">
