          ...
          <div class="row">
            ...
            <a href="<?php echo base_url().'home/agent_details';?>">
              <div class="feat_property list agent">
                <div class="thumb">
                  <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/team/a1.jpg" alt="a1.jpg">
                </div>
                <div class="details">
                  <div class="tc_content">
                    <h4><a href="<?php echo base_url().'home/agent_details';?>">Robert Fox</a></h4>
                    <p>Senior agent, Houzing Home</p>
                    <ul class="prop_details mb0">
                      <li class="text-left"><a href="#"><span>Office</span> &nbsp;91 456 9874</a></li>
                      <li class="text-left"><a href="#"><span>Mobile</span> 91 456 9874</a></li>
                      <li class="text-left"><a href="#"><span>Email</span> &nbsp;&nbsp; tomwilson@houzing.com</a></li>
                    </ul>
                  </div>
                  <div class="fp_footer">
            ...
            <div class="col-md-6 col-lg-6">
              ...
              <div class="feat_property list agent">
                <div class="thumb">
                  <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/team/a2.jpg" alt="a2.jpg">
                </div>
                <div class="details">
                  <div class="tc_content">
                    <h4>Esther Howard</h4>
