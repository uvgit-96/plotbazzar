    ...
    <div class="container"> 
      ...
      <nav> 
        ...
        <a href="index.html" class="navbar_brand dn-md">
          <img class="logo1 img-fluid" src="<?php echo base_url().'assets/web/';?>images/header-logo3.svg" alt="header-logo3.svg">
        ...
        <ul id="respMenu2" class="ace-responsive-menu float-right wa" data-menu-style="horizontal">
          ...
          <li class="list-inline-item add_listing"><a href="page-dashboard-new-property.html"><span class="icon flaticon-button vam mr3"></span><span class="dn-lg"> Create Listing</span></a></li>
        </ul>
      </nav>
    </div>
  </header>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-xl-3">
          <div class="feat_property">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/listing/rlsh31.jpg" alt="rlsh31.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">FEATURED</a></li>
                </ul>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="feat_property">
            <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/listing/rlsh32.jpg" alt="rlsh32.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">FEATURED</a></li>
                </ul>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="feat_property">
            <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/listing/rlsh33.jpg" alt="rlsh33.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">FEATURED</a></li>
                </ul>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="feat_property">
            <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/listing/rlsh34.jpg" alt="rlsh34.jpg">
              <div class="thmb_cntnt">
                <ul class="tag mb0">
                  <li class="list-inline-item"><a href="#">FEATURED</a></li>
                </ul>
