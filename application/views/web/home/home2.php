...
<!-- Favicon -->
<link href="<?php echo base_url().'assets/web/';?><?php echo base_url().'assets/web/';?>images/favicon.ico" sizes="128x128" rel="shortcut icon" type="image/x-icon" />
<link href="<?php echo base_url().'assets/web/';?><?php echo base_url().'assets/web/';?>images/favicon.ico" sizes="128x128" rel="shortcut icon" />
...
<div class="wrapper">
  ...
  <!-- Main Header Nav -->
  <header class="header-nav menu_style_home_one home2_style navbar-scrolltofixed stricky main-menu">
    <div class="container-fluid"> 
      ...
      <nav> 
        ...
        <a href="index.html" class="navbar_brand float-left dn-md">
					<img class="logo1 img-fluid" src="<?php echo base_url().'assets/web/';?>images/header-logo.svg" alt="header-logo.svg">
					<img class="logo2 img-fluid" src="<?php echo base_url().'assets/web/';?>images/header-logo2.svg" alt="header-logo2.svg">
					<span>Houzing</span>
				</a> 
        <!-- Responsive Menu Structure-->
        <ul id="respMenu" class="ace-responsive-menu custom_menu_space_home2 text-center wa" data-menu-style="horizontal">
        ...
        <ul id="respMenu2" class="ace-responsive-menu widget_menu_home2 wa" data-menu-style="horizontal">
          ...
          <li class="list-inline-item add_listing style2"><a href="page-add-new-property.html"><span class="icon flaticon-button"></span><span class="dn-lg"> Create Listing</span></a></li>
        </ul>
      </nav>
    </div>
  </header>
  ...
  <!-- Home Design -->
  <section class="home-one home2-overlay bg-home2">
    <div class="container">
  ...
  <!-- Hot Location of City -->
  <section class="hot_localtion pb70">
    <div class="container">
      <div class="row">
                ...
                <div class="popular_listing_slider1">
                  <div class="item">
                    <div class="feat_property">
                      <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/fl1.jpg" alt="fl1.jpg">
                  ...
                  <div class="item">
                    <div class="feat_property">
                      <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/fl2.jpg" alt="fl2.jpg">
                        <div class="thmb_cntnt">
                          <ul class="tag mb0">
                            <li class="list-inline-item"><a href="#">FEATURED</a></li>
                          </ul>
                  ...
                  <div class="item">
                    <div class="feat_property">
                      <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/fl3.jpg" alt="fl3.jpg">
                        <div class="thmb_cntnt">
                          <ul class="tag mb0">
                            <li class="list-inline-item"><a href="#">FEATURED</a></li>
                          </ul>
                  ...
                  <div class="item">
                    <div class="feat_property">
                      <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/fl4.jpg" alt="fl4.jpg">
                        <div class="thmb_cntnt">
                          <ul class="tag mb0">
                            <li class="list-inline-item"><a href="#">FEATURED</a></li>
                          </ul>
  ...
  <section class="recent-property pb70">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="recent_property_slider_home2">
            <div class="item">
              <div class="feat_property map">
                <div class="thumb">
                  <a href="#"><img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/location.png" alt="location.png"></a>
                </div>
                <div class="details">
                  <div class="tc_content">
                    <h4><a href="page-listing-single-v3.html">New York</a></h4>
                    <p><span class="heading-color">359</span> listings for sale <br> Median listing price <span class="heading-color">$147,350</span></p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="item">
              <div class="feat_property map">
                ...
                <div class="details">
                  <div class="tc_content">
                    <h4><a href="page-listing-single-v3.html">Istanbul</a></h4>
                    <p><span class="heading-color">359</span> listings for sale <br> Median listing price <span class="heading-color">$147,350</span></p>
                  </div>
                </div>
              </div>
            ...
            <div class="item">
              <div class="feat_property map">
                ...
                <div class="details">
                  <div class="tc_content">
                    <h4><a href="page-listing-single-v3.html">Los Angeles</a></h4>
                    <p><span class="heading-color">359</span> listings for sale <br> Median listing price <span class="heading-color">$147,350</span></p>
                  </div>
                </div>
              </div>
  ...
  <!-- Recent Property For Rent -->
  <section class="recent-property pb70 bt1">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="main-title text-center">
      ...
      <div class="row">
        <div class="col-md-6 col-xl">
          <div class="feat_property all_listing_style3">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/lls31.jpg" alt="lls31.jpg">
              <div class="thmb_cntnt">
                <ul class="tag2 mb0">
            ...
            <div class="details">
              <div class="tc_content">
                ...
                <p>Quincy St, Brooklyn, NY, USA</p>
                <ul class="prop_details mb0">
                  <li class="list-inline-item"><a href="#"><span class="flaticon-bed vab pr5"></span> 4</a></li>
                  <li class="list-inline-item"><a href="#"><span class="flaticon-bath vab pr5"></span> 5</a></li>
                  <li class="list-inline-item"><a href="#"><span class="flaticon-car vab pr5"></span> 1</a></li>
                  <li class="list-inline-item"><a href="#"><span class="flaticon-ruler vab pr5"></span> 1200 Sq Ft</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6 col-xl">
          <div class="feat_property all_listing_style3">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/lls32.jpg" alt="lls32.jpg">
              <div class="thmb_cntnt">
                <ul class="tag2 mb0">
                  <li class="list-inline-item"><a href="#">SOLD</a></li>
                </ul>
        ...
        <div class="col-md-6 col-xl">
          <div class="feat_property all_listing_style3">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/lls33.jpg" alt="lls33.jpg">
              <div class="thmb_cntnt">
                <ul class="tag2 mb0">
                  <li class="list-inline-item"><a href="#">SOLD</a></li>
                </ul>
        ...
        <div class="col-md-6 col-xl">
          <div class="feat_property all_listing_style3">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/lls34.jpg" alt="lls34.jpg">
              <div class="thmb_cntnt">
                <ul class="tag2 mb0">
                  <li class="list-inline-item"><a href="#">SOLD</a></li>
                </ul>
        ...
        <div class="col-md-6 col-xl">
          <div class="feat_property all_listing_style3">
            <div class="thumb">
              <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/property/lls35.jpg" alt="lls35.jpg">
              <div class="thmb_cntnt">
                <ul class="tag2 mb0">
                  <li class="list-inline-item"><a href="#">SOLD</a></li>
                </ul>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <div class="modern_appartment_widget text-center">
            <p class="fz16 text-white text-uppercase">$79 at night</p>
            <h2 class="title text-white mb20">Modern Apartment</h2>
            <ul class="">
              <li class="list-inline-item"><a class="text-white" href="#"><span class="icon flaticon-bed vab"></span> <br> 4 Beds</a></li>
              <li class="list-inline-item"><a class="text-white" href="#"><span class="icon flaticon-bath vab"></span> <br> 5 Baths</a></li>
              <li class="list-inline-item"><a class="text-white" href="#"><span class="icon flaticon-car vab"></span> <br> 1 Garage</a></li>
              <li class="list-inline-item"><a class="text-white" href="#"><span class="icon flaticon-ruler vab"></span> <br> 1200 Sq Ft</a></li>
            </ul>
            <a class="btn" href="#">VIEW PROPERTY</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-xl-3">
          <div class="for_blog feat_property home2">
            <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/blog/1.jpg" alt="1.jpg">
            ...
            <div class="details">
              <div class="tc_content">
                ...
                <a class="heading-color tdu read_more_btn" href="page-blog-single.html">READ MORE</a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-xl-3">
          <div class="for_blog feat_property home2">
            <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/blog/2.jpg" alt="2.jpg">
              <div class="tag bgc-thm"><a class="text-white" href="#">APARTMENT</a></div>
            </div>
            <div class="details">
              <div class="tc_content">
                <div class="bp_meta">
        ...
        <div class="col-md-6 col-xl-3">
          <div class="for_blog feat_property home2">
            <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/blog/3.jpg" alt="3.jpg">
              <div class="tag bgc-thm"><a class="text-white" href="#">APARTMENT</a></div>
            </div>
            <div class="details">
              <div class="tc_content">
        ...
        <div class="col-md-6 col-xl-3">
          <div class="for_blog feat_property home2">
            <div class="thumb"> <img class="img-whp" src="<?php echo base_url().'assets/web/';?>images/blog/4.jpg" alt="4.jpg">
              <div class="tag bgc-thm"><a class="text-white" href="#">RENTAL</a></div>
            </div>
            <div class="details">
              <div class="tc_content">
                <div class="bp_meta">
    ...
    <div class="container pb90">
      <div class="row">
        <div class="col-sm-5 col-md-5 col-lg-3 col-xl-2">
          ...
          <div class="footer_social_widget home2 mt20">
            <ul class="mb0">
        ...
        <div class="col-sm-4 col-md-3 col-lg-2 col-xl-2">
          <div class="footer_qlink_widget home2 pl0">
    ...
    <div class="container pt10 pb30">
      <div class="row">
        <div class="col-md-4 col-lg-4">
          <div class="copyright-widget home2 mt10 mb15-767">
            <p>Copyright © 2021 CreativeLayers. All Right Reserved.</p>
          </div>
        </div>
        <div class="col-md-4 col-lg-4">
          <div class="footer_logo_widget home2 text-center mb15-767">
            <div class="wrapper">
              <div class="logo text-center"> <img src="<?php echo base_url().'assets/web/';?>images/footer-logo.svg" alt="footer-logo.svg"> <span class="logo_title text-white pl15">Houzing</span> </div>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-lg-4">
          <div class="footer_menu_widget home2 text-right tac-md mt15">
            <ul>
  ...
  <a class="scrollToHome home2" href="#"><i class="fa fa-angle-up"></i></a> </div>
<!-- Wrapper End --> 
