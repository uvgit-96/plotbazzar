      ...
      <div class="card card-default">
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
            <a href="<?= base_url('app/admin_roles/module'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  Module List</a>
          </div>
        </div>
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('app/admin_roles/module_add'), 'class="form-horizontal"');  ?>
