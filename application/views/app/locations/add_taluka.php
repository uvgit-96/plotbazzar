<section class="content">
   <div class="card card-default">
      ...
      <div class="card-body">
         ...
         <?php echo form_open_multipart(base_url('app/locations/add_taluka'), array("class"=>"form-horizontal"));  ?>
         ...
         <div class="form-group">
            ...
            <div class="col-md-12">
               <input type="text" name="name" class="form-control" id="name" placeholder="Enter Taluka Name" required>
            </div>
         </div>
         <div class="form-group">
            <div class="col-md-12 text-center">
               <input type="submit" name="submit" value="Add Taluka" class="btn btn-primary pull-right">
            </div>
         </div>
         <?php echo form_close( ); ?>
      </div>
