   ...
   <div class="card card-default">
      <div class="card-header">
         ...
         <div class="d-inline-block float-right">
            <a href="<?php echo base_url('app/tl_member'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Team Member List</a>
         </div>
      </div>
      <div class="card-body">
         <!-- For Messages -->
         <?php $this->load->view('app/includes/_messages.php') ?>
         <?php echo form_open_multipart(base_url('app/tl_member/edit/'.$tl_details['id']), array("class"=>"form-horizontal","id"=>"quickForm"));  ?>
           ...
           <input type="hidden" name="old_aadhaar_no" value="<?php echo $tl_details['aadhaar_no']; ?>">
           <input type="hidden" name="old_pan_no" value="<?php echo $tl_details['pan_no']; ?>">
         ...
         <div class="form-group">
            ...
            <div class="col-md-12">
               <input type="text" name="firstname" class="form-control" id="firstname" placeholder="Enter First Name"  value="<?php echo $tl_details['firstname']; ?>" >
            </div>
         </div>
         <div class="form-group">
            <label for="lastname" class="col-md-12 control-label">Last Name<span class="req_sign">  *</span></label>
            <div class="col-md-12">
               <input type="text" name="lastname" class="form-control" id="lastname" placeholder="Enter Last Name"  value="<?php echo $tl_details['lastname']; ?>" >
            </div>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            <label for="date_of_birth" class="col-md-12 control-label">Date of Birth<span class="req_sign">  *</span></label>
            <div class="col-md-12">
         ...
         <div class="form-group">
            <div class="col-md-12 text-center">
               <input type="submit" name="submit" value="Update Member Details" class="btn btn-primary pull-right">
            </div>
         </div>
         <?php echo form_close( ); ?>
      </div>
