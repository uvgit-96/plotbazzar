...
$route['post-property'] = 'User_dashboard/Post_property';	
$route['profile'] = 'User_dashboard/Profile';
$route['property-list'] = 'User_dashboard/Property_list';
$route['invoice'] = 'User_dashboard/Invoice';	
